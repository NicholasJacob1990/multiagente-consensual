---
description: Coordena swarm com recrutamento e remoção controlados
argument-hint: <objetivo, supervisor, pool e limites>
alias-de: workflow-agentes
profile: swarm_dinamico_v1
---
Use a skill `workflow-agentes` com `protocolo = swarm_dinamico_v1`. Congele supervisor, pool elegível, membros iniciais, limites de membros, expansões, gerações e orçamento. Mostre a prévia e aguarde confirmação. Nunca recrute fora do pool nem amplie permissões.
