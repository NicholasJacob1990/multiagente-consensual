---
description: Seleciona modelos dinamicamente por qualidade, custo, latência e falha
argument-hint: <tarefas, pool, métricas, pesos e limites>
alias-de: workflow-agentes
profile: roteamento_adaptativo_v1
---
Use a skill `workflow-agentes` com `protocolo = roteamento_adaptativo_v1`. Congele pool, restrições, métricas, pesos, exploração e fallbacks; mostre ranking e desconhecidos na prévia e aguarde confirmação. Nunca escolha fora do pool nem trate custo desconhecido como zero.
