---
description: Status atual dos 3 backends do a2a mesh
entrypoint: workflow-agentes
profile: a2a_status
approval-ceiling: none
---
Invoque a tool MCP `mcp__a2a-mesh__a2a_status` sem argumentos e formate o resultado mostrando: nome do agente, porta, modelo, modo (cli/api), tasks ativas e status (ok/down).
