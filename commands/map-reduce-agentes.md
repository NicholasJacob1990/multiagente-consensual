---
description: Divide entradas, executa maps rastreáveis e reduz resultados
argument-hint: <entrada, partição, mappers, reducers e objetivo>
alias-de: workflow-agentes
profile: map_reduce_v1
---
Use a skill `workflow-agentes` com `protocolo = map_reduce_v1`. Defina partição, cobertura, função map, chave de shuffle, reducers, função reduce e auditor. Mostre a prévia e aguarde confirmação. Preserve a procedência de cada achado.
