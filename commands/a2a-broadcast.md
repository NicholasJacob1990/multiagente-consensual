---
description: Envia o mesmo prompt aos agentes selecionados do mesh em paralelo
argument-hint: <prompt>
entrypoint: workflow-agentes
profile: a2a_broadcast
approval-ceiling: none
---
Invoque a tool MCP `mcp__a2a-mesh__a2a_broadcast` com o prompt abaixo. Sem seleção explícita, use os agentes efetivamente online entre codex, claude, gemini, grok, glm, deepseek, kimi e qwen. Retorne cada resposta lado a lado, mantendo autoria, rota e separações; não substitua silenciosamente uma cadeira indisponível.
