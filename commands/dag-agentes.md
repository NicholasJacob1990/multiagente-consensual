---
description: Executa grafo acíclico de tarefas com ondas paralelas e joins
argument-hint: <nós, dependências e objetivo>
alias-de: workflow-agentes
profile: dag_assincrono_v1
---
Use a skill `workflow-agentes` com `protocolo = dag_assincrono_v1`. Resolva nós, arestas, joins, paralelismo e falhas; valide aciclicidade e mostre as ondas na prévia. Aguarde confirmação antes das chamadas.
