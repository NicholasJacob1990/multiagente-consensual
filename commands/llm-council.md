---
description: Executa o LLM Council para debate adversarial multimodelo
argument-hint: "<tarefa e configuração opcional>"
entrypoint: consenso
profile: llm_council
approval-ceiling: consultivo
---

Use `$llm-council` como perfil consultivo da camada `$consenso` para `$ARGUMENTS`. Escolha o subagente e o modo adequados, respeitando modelos explicitamente indicados. Sua síntese não é aprovação sem o gate central.
