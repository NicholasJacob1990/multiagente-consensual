---
description: Registra o resultado posterior de uma decisão do Agent Council
argument-hint: "<session-id> <resultado observado>"
entrypoint: consenso
profile: council_outcome
approval-ceiling: none
---

Use `$council-outcome` com: $ARGUMENTS
