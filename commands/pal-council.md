---
description: Convoca o conselho do MCP pal-council
argument-hint: "<questão e modelos>"
entrypoint: consenso
profile: pal_council
approval-ceiling: consultivo
---

Use somente as ferramentas do MCP `pal-council` para `$ARGUMENTS`. Se faltar autenticação, informe o requisito.
