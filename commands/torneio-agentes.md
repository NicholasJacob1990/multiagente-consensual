---
description: Compara candidatos em chave eliminatória cega
argument-hint: <candidatos, juízes, rubrica e formato>
alias-de: workflow-agentes
profile: torneio_eliminatorio_v1
---
Use a skill `workflow-agentes` com `protocolo = torneio_eliminatorio_v1`. Congele candidatos, hashes, seed, bracket, juízes, rubrica e desempate antes dos confrontos. Mostre a prévia e aguarde confirmação. O vencedor é candidato selecionado, não artefato aprovado.
