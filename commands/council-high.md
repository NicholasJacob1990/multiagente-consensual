---
description: Convoca o Council of High Intelligence
argument-hint: "[modo e membros] <questão>"
entrypoint: consenso
profile: council_high
approval-ceiling: consultivo
---

Use `$council-high` como perfil consultivo da camada `$consenso` para analisar `$ARGUMENTS`. Respeite o modo e os membros indicados, preserve dissensos e nunca dê voto ou poder de veredito a cadeira simulada. Para aprovação vinculante, submeta a versão ao contrato `veredito_consenso_v1`.
