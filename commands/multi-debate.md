---
description: Executa debate pelo MCP multi-debate
argument-hint: "<tema, participantes e limites>"
entrypoint: consenso
profile: multi_debate
approval-ceiling: consultivo
---

Use somente as ferramentas do MCP `multi-debate` para `$ARGUMENTS`. Não substitua o servidor silenciosamente e informe dissensos.
