---
description: Executa debate estruturado pelo MCP sage-debate
argument-hint: "<tema, papéis, rodadas e critérios>"
entrypoint: consenso
profile: sage_debate
approval-ceiling: consultivo
---

Use somente as ferramentas do MCP `sage-debate` para `$ARGUMENTS`. Preserve críticas, réplicas, revisões e dissensos.
