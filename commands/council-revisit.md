---
description: Reavalia uma decisão anterior do Agent Council
argument-hint: "<session-id> [novo contexto]"
entrypoint: consenso
profile: council_revisit
approval-ceiling: consultivo
---

Use `$council-revisit` com: $ARGUMENTS
