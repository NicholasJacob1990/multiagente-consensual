    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          recursive: { type: 'boolean', description: 'Advanced opt-in: allow recipients to delegate further. Default false.' },
          ...asyncControlProperties,
        },
        required: ['prompt'],
      },
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          profile: { type: 'string', enum: ['fast', 'normal', 'deep'], description: 'Work profile controlling default depth when the workflow uses it.' },
          ...asyncControlProperties,
        },
        required: ['steps'],
      },
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          profile: { type: 'string', enum: ['fast', 'normal', 'deep'], description: 'Work profile: fast, normal or deep.' },
          ...asyncControlProperties,
        },
        required: ['prompt'],
      },
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          profile: { type: 'string', enum: ['fast', 'normal', 'deep'], description: 'Work profile. Explicit rounds override its default.' },
          ...asyncControlProperties,
        },
        required: ['topic'],
      },
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          judge: { type: 'string', description: `Judge agent (default: claude). Options: ${peerNames}` },
          profile: { type: 'string', enum: ['fast', 'normal', 'deep'], description: 'fast=1 cycle, normal=2, deep=5 unless rounds is supplied.' },
          deduplicate: { type: 'boolean', description: 'Group conservatively identical candidates before review (default true except deep).' },
          early_exit: { type: 'boolean', description: 'Skip review/revise when all candidates are identical, while retaining judge validation.' },
          ...asyncControlProperties,
        },
        required: ['task'],
      },
